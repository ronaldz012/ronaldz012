...
I don't just use tools; I master my environment to maximize efficiency.
* **Environment:** Powered by **Arch Linux + Hyprland**. My workflow is a reflection of my engineering mindset: minimalist, automated, and highly optimized. This deep understanding of Linux internals translates directly into my **DevOps** and **Server Management** capabilities.
* **Approach:** Pragmatic and result-oriented. I understand that software must generate **revenue and value**. I balance technical debt with time efficiency and clear client communication.
